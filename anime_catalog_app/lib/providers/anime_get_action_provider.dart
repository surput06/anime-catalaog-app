...
class AnimeGetActionProvider with ChangeNotifier {
  final AnimeRepostories _animeRepostories;

  AnimeGetActionProvider(this._animeRepostories);
  ...
  void getRomance(BuildContext context) async {
    ...
    final result = await _animeRepostories.getAction();
  ...
  void getActionPaging(
    BuildContext context, {
    required int page,
    required PagingController pagingController,
  }) async {
    final result = await _animeRepostories.getAction(page: page);
