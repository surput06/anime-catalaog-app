...
class AnimeGetSciFiProvider with ChangeNotifier {
  final AnimeRepostories _animeRepostories;

  AnimeGetSciFiProvider(this._animeRepostories);
  ...
  void getSciFi(BuildContext context) async {
    _isLoading = true;
    notifyListeners();

    final result = await _animeRepostories.getSciFi();
  ...
  void getSciFiPaging(
    ...
    final result = await _animeRepostories.getSciFi(page: page);
